...
class ConvolutionalBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, conv=nn.Conv2d, batch_norm=False,
                 activation=None):
        """
...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, kernel_size=3, n_channels=64, conv=nn.Conv2d):
        """
        :param kernel_size: kernel size
        ...
        self.conv_block1 = ConvolutionalBlock(in_channels=n_channels, out_channels=n_channels, kernel_size=kernel_size,
                                              batch_norm=True, activation='PReLu', conv=conv)

        # The second convolutional block
        self.conv_block2 = ConvolutionalBlock(in_channels=n_channels, out_channels=n_channels, kernel_size=kernel_size,
                                              batch_norm=True, activation=None, conv=conv)
...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=32, n_blocks=8, scaling_factor=2,
        ...
        self.conv_block2 = ConvolutionalBlock(in_channels=n_channels, out_channels=n_channels,
                                              ...
                                              batch_norm=True, activation=None,conv=nn.Conv2d)

        # Upscaling is done by sub-pixel convolution, with each such block upscaling by a factor of 2
        n_subpixel_convolution_blocks = int(math.log2(scaling_factor))
        self.subpixel_convolutional_blocks = nn.Sequential(
            *[SubPixelConvolutionalBlock(kernel_size=small_kernel_size, n_channels=n_channels, scaling_factor=2,conv=nn.Conv2d) for i
